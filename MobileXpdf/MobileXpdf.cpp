// MobileXpdf.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CMobileXpdfApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CMobileXpdfApp::OnAppAbout)
	ON_COMMAND(ID_MENU_QUIT, &CMobileXpdfApp::OnMenuQuit)
END_MESSAGE_MAP()



// CMobileXpdfApp construction
CMobileXpdfApp::CMobileXpdfApp()
	: CWinApp()
{
...
// The one and only CMobileXpdfApp object
CMobileXpdfApp theApp;

// CMobileXpdfApp initialization

BOOL CMobileXpdfApp::InitInstance()
{
...
// $$$AD
	...
	SetRegistryKey(L"MobileXpdf.sf.net");
...
// CMobileXpdfApp message handlers
...
void CAboutDlg::OnSize(UINT /*nType*/, int /*cx*/, int /*cy*/)
{
	DRA::RelayoutDialog(
		...
		this->m_hWnd, 
		DRA::GetDisplayMode() != DRA::Portrait ? MAKEINTRESOURCE(IDD_ABOUTBOX) : MAKEINTRESOURCE(IDD_ABOUTBOX));
}
#endif

// App command to run the dialog
void CMobileXpdfApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

void CMobileXpdfApp::OnMenuQuit()
{
	//m_pMainWnd->PostMessageW(WM_CLOSE,0,0);
	OnAppExit();
}

int CMobileXpdfApp::ExitInstance()
{
...
void CMobileXpdfApp::CheckForRunningInstance(void)
{
