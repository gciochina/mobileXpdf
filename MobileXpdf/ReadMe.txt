================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : MobileXpdf Project Overview
===============================================================================

The application wizard has created this MobileXpdf application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your MobileXpdf application.
...
MobileXpdf.h
    ...
    project specific headers and declares the CMobileXpdfApp application class.

MobileXpdf.cpp
    This is the main application source file that contains the application
    class CMobileXpdfApp.


MobileXpdfppc.rc
    This is the project's main resource file listing of all of the Microsoft Windows
    resources that the project uses when compiling for the Mobile PC platform, or a
...
StdAfx.h, StdAfx.cpp
    ...
    named MobileXpdf.pch and a precompiled types file named StdAfx.obj.
